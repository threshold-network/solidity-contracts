...
interface IApplication {
    ...
    function authorizationIncreased(address operator, uint256 amount) external;
    ...
    function authorizationDecreaseRequested(address operator, uint256 amount)
        external;
    ...
    function involuntaryAuthorizationDecrease(address operator, uint256 amount)
        external;
}
